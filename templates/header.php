	...
	<nav class="navbar navbar-expand-lg w-100 bg-light">
		<div class="navbar-collapse collapse justify-content-between">
			...
			<li class="nav-item cart mr-4">
					<a class="nav-link " href="templates/user.php">
						
						<i class="fa fa-user text-black" style="font-size: 18px;"></i>
					</a>
				</li>

				<li class="nav-item cart mr-4">
					<a class="nav-link " href="<?php echo $server; ?>templates/cart.php">
						<span class="text-white">0 </span>
						<i class="fa fa-shopping-cart text-black" style="font-size: 18px;"></i>
					</a>
				</li>
